...
while True:
    ...
    if candle_lit == "no":
        print("\nGood choice. You are safe and may continue living")
        exit()
...
if move1 == "guest room":
    input("\nYou chose to enter the guest room.")
    ...
    while True:
        ...
        #Game continues
            ...
            print("\nPerhaps you are not tired enough. There is not much to do, so you head to a different location\n\n")
            while True:
...
if move1 == "bathroom" or othermove1 == "bathroom":
    input("\nYou chose to enter the Bathroom")
    ...
    while True:
        ...
        if lights == "yes":
         ...
         #Game continues   
            ...
            print("\nDoing your business with the lights off? You fear nothing!\n\n")
            while True:
...
if move1 == "stairs" or othermove1 == "stairs" or othermove2 == "stairs":
    ...
    while True:
        ...
        #Game continues   
            ...
            print("\nYou chose to face your fears and continue the game. Little did you know, it also saved your life!")
